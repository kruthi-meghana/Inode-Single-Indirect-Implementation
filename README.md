...
# ProblemStatement
      ...
      To build a C++ application that handles five different forums, its users, their msgs, likes and
      comments. The whole idea of this project is to implement the Inode data structure in 
